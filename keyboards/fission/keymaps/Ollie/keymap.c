 ...
 * |   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /   |
 * '-------------+------+------+------|      |------+------+------+--------------'
 *               |  PAD | SCUT |EntCtl|      | RSHFT| Space| BKSP | 
 *               `--------------------'      `--------------------'
 */
[BASE] = LAYOUT(
   ...
   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
          MO(PAD), LT(SCUTS,KC_LWIN),LCTL_T(KC_ENTER),KC_LSHIFT,KC_SPC, KC_BSPACE                  \
),
...
[PAD] = LAYOUT(
   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_GRAVE,      KC_PPLS, KC_7,    KC_8,    KC_9,    KC_0,    \
   KC_F5,   KC_F6,   KC_F7,   KC_F8,   TO(GAME),      KC_PMNS, KC_4,    KC_5,    KC_6,    KC_ESC, \
   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,       KC_PSLS, KC_1,    KC_2,    KC_3,    KC_ENT, \
